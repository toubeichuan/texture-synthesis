...
from lib.diffusion_helper import (
    ...
    apply_controlnet_inpaint_withReference,
...
--output_dir outputs_cat_refer04
--obj_file cat.obj
...
if __name__ == "__main__":
    ...
    for view_idx in range(NUM_PRINCIPLE):
        ...
        if view_idx == 0 and args.override_rendering_0 and args.skip_view0_new_stage:
            ...
            generate_image, generate_image_before, generate_image_after = apply_controlnet_inpaint_withReference(
                inpaint_pipe_sd15,
