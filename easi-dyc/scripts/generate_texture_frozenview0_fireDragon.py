...
--output_dir outputs_firedragon_generate_texture_firedragon_lockedview0_test02WithCor_1.4
--obj_file cat.obj
--prompt "cute chibi 3D cartoon baby fire lizard dragon, orange skin, Cream-colored belly, big glossy eyes,tail with small flame glow"
...
def _get_apply_controlnet_optional_kwargs(reference_image=None):
    ...
    optional_kwargs = {}
    try:
        sig = inspect.signature(apply_controlnet_depth)
...
if __name__ == "__main__":
    ...
    for view_idx in range(NUM_PRINCIPLE):
        ...
        if not args.no_update and update_mask_tensor.sum() > 0:
            print(
