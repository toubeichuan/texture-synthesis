...
--output_dir outputs_cat_new_04_13
--obj_file cat.obj
...
if __name__ == "__main__":
    ...
    # SD2 inpainting model: 由于 new-stage 现在默认走 apply_controlnet_inpaint，这里直接加载，避免 None 报错。
    # （如果你未来想切回 ControlNet RePaint，可再改回“按开关加载”。）
    inpainting_sd2 = get_inpainting(DEVICE)
